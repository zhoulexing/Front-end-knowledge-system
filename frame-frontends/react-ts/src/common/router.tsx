...
const getRouterConfig = () => ({
  "/apps": {
    component: dynamicWrapper(() => import(
  ...
  "/apps/react": {
    component: dynamicWrapper(() => import(/* webpackChunkName: "es2020" */ "@/routes/React")),
  },
  "/apps/exception/404": {
    component: dynamicWrapper(() => import(/* webpackChunkName: "404" */ "@/routes/Exception/404")),
  },
  "/login": {
    component: dynamicWrapper(() => import(
